...
global F_NOISE G_TRUTH BASIS INPUT PATCH_SIZE KernelPara MFS T Q_UPPER Q_LOWER DCT_MTX
...
for s = 1:stage;
    ...
    KernelPara.cof = x;
    [loss, deImg] = loss_specific_model(G_TRUTH, INPUT, Q_UPPER, Q_LOWER, KernelPara, MFS, T, DCT_MTX, 0);
    ...
    save('training_deblocking_7x7_400_176x176_greedy_stage=5.mat','cof','stage_err','stage','MFS');
end