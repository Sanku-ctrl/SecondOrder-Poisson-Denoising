function grad = grad_l_thetas(AllNetWorks, trained_model, input, basis, R, psz, KernelPara, mfs, s, DCT_MTX)
NumW = mfs.NumW;
...
parfor samp = 1:R
    ...
    grad_l_x = dct_t*(ind_s(:,samp).*(dct_mtx*grad_l_u(:,samp)));
    v = reshape(grad_l_x,r,c);
    for i=1:filtN
        k = K{i};
        %% part 1
