...
% load training_process_5x5_180_newRBFs.mat;
% load training_process_7x7_180.mat;
% load training_7x7_400_180_NoBeta.mat;
% load training_7x7_400_180_NoBeta_sigma=15.mat;
% load training_5x5_400_180_NoBeta_PSNR.mat;
% load training_temp_cof;
load JointTraining_7x7_400_180x180_stage=5_plain_initial.mat;
...
for s = 1:check_s
    ...
    sfigure(100);
    DisplayFilters(trained_model{s}.K,4,12);drawnow;
    for i=1:filtN
        sfigure(i);
        subplot(1,2,1);
